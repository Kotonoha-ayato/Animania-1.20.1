...
/** Server-authoritative GenericAIOwnerHurtByTarget replacement for dogs. */
public final class AnimaniaOwnerHurtByTargetGoal extends Goal {
    private final AnimaniaAnimalEntity animal;
    private LivingEntity target;
    private int lastTimestamp = -1;

    public AnimaniaOwnerHurtByTargetGoal(AnimaniaAnimalEntity animal) {
        this.animal = animal;
