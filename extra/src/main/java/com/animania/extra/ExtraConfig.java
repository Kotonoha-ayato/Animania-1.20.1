...
public final class ExtraConfig {
    ...
    static {
        ...
        FERRET_FOOD = builder.defineList("ferretFood", List.of("minecraft:mutton", "minecraft:egg", "animania_farm:brown_egg", "animania_extra:peacock_egg_blue", "animania_extra:peacock_egg_white", "animania_farm:raw_prime_mutton", "animania_extra:raw_prime_rabbit", "minecraft:rabbit", "minecraft:chicken", "animania_farm:raw_prime_chicken"), value -> value instanceof String);
        HAMSTER_FOOD = builder.defineList("hamsterFood", List.of("animania_extra:hamster_food", "minecraft:wheat_seeds", "minecraft:melon_seeds", "minecraft:beetroot_seeds", "minecraft:pumpkin_seeds", "simplecorn:corncob", "biomesoplenty:turnip_seeds", "harvestcraft:cornitem", "minecraft:apple"), value -> value instanceof String);
        HEDGEHOG_FOOD = builder.defineList("hedgehogFood", List.of("minecraft:carrot", "minecraft:beetroot", "minecraft:egg", "animania_farm:brown_egg", "animania_extra:peacock_egg_blue", "animania_extra:peacock_egg_white", "animania_farm:raw_prime_mutton", "animania_extra:raw_prime_rabbit", "minecraft:rabbit", "minecraft:chicken", "animania_farm:raw_prime_chicken", "minecraft:apple"), value -> value instanceof String);
        PEACOCK_FOOD = builder.defineList("peacockFood", List.of("minecraft:wheat_seeds", "minecraft:melon_seeds", "minecraft:beetroot_seeds", "minecraft:pumpkin_seeds", "simplecorn:corncob", "biomesoplenty:turnip_seeds", "harvestcraft:cornitem"), value -> value instanceof String);
        ...
        beds.put("ferretBed", builder.define("ferretBed", "animania:straw"));
        beds.put("ferretBed2", builder.define("ferretBed2", "minecraft:grass_block"));
        beds.put("hamsterBed", builder.define("hamsterBed", "animania:straw"));
        beds.put("hamsterBed2", builder.define("hamsterBed2", ""));
        beds.put("hedgehogBed", builder.define("hedgehogBed", "animania:straw"));
        beds.put("hedgehogBed2", builder.define("hedgehogBed2", "minecraft:grass_block"));
        beds.put("peacockBed", builder.define("peacockBed", "animania:straw"));
        beds.put("peacockBed2", builder.define("peacockBed2", "minecraft:grass_block"));
        beds.put("rabbitBed", builder.define("rabbitBed", "animania:straw"));
