...
public final class ExtraNativeModelLayers {
    ...
    private static LayerDefinition model_hamster_wheel() {
        ...
        PartDefinition base1 = root.addOrReplaceChild("base1", CubeListBuilder.create().texOffs(12, 1).addBox(-1.0F, -13.0F, -0.5F, 1.0F, 13.0F, 1.0F), PartPose.offsetAndRotation(6.0F, 0.0F, -6.0F, 0.0F, 0.0F, -1.570796F));
        PartDefinition base2 = base1.addOrReplaceChild("base2", CubeListBuilder.create().texOffs(12, 1).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 13.0F, 1.0F), PartPose.offsetAndRotation(-10.5F, 0.5F, 0.0F, 0.0F, 0.0F, 2.094395F));
        ...
        PartDefinition base3 = base1.addOrReplaceChild("base3", CubeListBuilder.create().texOffs(12, 1).addBox(-1.0F, -13.0F, -0.5F, 1.0F, 13.0F, 1.0F), PartPose.offsetAndRotation(0.5F, 6.499999F, 12.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition base4 = base3.addOrReplaceChild("base4", CubeListBuilder.create().texOffs(12, 1).addBox(-0.5F, -12.5F, -0.5F, 1.0F, 13.0F, 1.0F), PartPose.offsetAndRotation(-10.5F, 0.5F, 0.0F, 0.0F, 0.0F, 2.094395F));
    ...
    private static LayerDefinition hamster() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        PartDefinition hamster_body = root.addOrReplaceChild("hamster_body", CubeListBuilder.create().texOffs(28, 8).addBox(-2.5F, -4.0F, -2.5F, 5.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, 1.570796F, 0.0F, 0.0F));
