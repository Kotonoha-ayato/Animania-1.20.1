...
public final class CatsDogsNativeModelLayers {
    ...
    private static LayerDefinition model_cat_bed_1() {
        ...
        PartDefinition block1 = root.addOrReplaceChild("block1", CubeListBuilder.create().texOffs(1, 1).addBox(-5.0F, -0.5F, -7.5F, 10.0F, 1.0F, 15.0F), PartPose.offsetAndRotation(-0.25F, 23.5F, 0.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition block1_2 = root.addOrReplaceChild("block1_2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -2.0F, -8.0F, 1.0F, 4.0F, 16.0F), PartPose.offsetAndRotation(-5.5F, 22.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition block1_3 = root.addOrReplaceChild("block1_3", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -2.0F, -8.0F, 1.0F, 4.0F, 16.0F), PartPose.offsetAndRotation(5.0F, 22.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition block1_4 = root.addOrReplaceChild("block1_4", CubeListBuilder.create().texOffs(15, 15).addBox(-5.0F, -2.0F, -0.5F, 10.0F, 4.0F, 1.0F), PartPose.offsetAndRotation(-0.25F, 22.0F, 7.5F, 0.0F, 0.0F, 0.0F));
        PartDefinition block1_5 = root.addOrReplaceChild("block1_5", CubeListBuilder.create().texOffs(-14, -14).addBox(-4.5F, -0.5F, -7.0F, 9.0F, 1.0F, 14.0F), PartPose.offsetAndRotation(-0.25F, 23.0F, 0.0F, 0.0F, 0.0F, 0.0F));
    ...
    private static LayerDefinition model_cat_tower() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        PartDefinition root_node = root.addOrReplaceChild("root_node", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 16.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        ...
        PartDefinition ramp = base.addOrReplaceChild("ramp", CubeListBuilder.create().texOffs(31, 68).addBox(-2.5F, 1.5F, -10.0F, 5.0F, 1.0F, 20.0F), PartPose.offsetAndRotation(5.5F, -6.0F, -6.5F, 0.993109F, 0.0F, 0.0F));
        return LayerDefinition.create(mesh, 128, 128);
    }
    private static LayerDefinition model_dog_house() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        PartDefinition block1 = root.addOrReplaceChild("block1", CubeListBuilder.create().texOffs(4, 1).addBox(-0.5F, -7.0F, -8.0F, 1.0F, 14.0F, 16.0F), PartPose.offsetAndRotation(-7.5F, 17.0F, 0.0F, 0.0F, 0.0F, 0.0F));
        ...
        PartDefinition block1_8 = root.addOrReplaceChild("block1_8", CubeListBuilder.create().texOffs(26, 32).addBox(-0.5F, -7.0F, -9.0F, 1.0F, 14.0F, 18.0F), PartPose.offsetAndRotation(4.52F, 6.5F, 0.0F, 0.0F, 0.0F, -0.785398F));
        ...
        PartDefinition block1_14 = root.addOrReplaceChild("block1_14", CubeListBuilder.create().texOffs(15, 15).addBox(-2.0F, -7.0F, -0.5F, 2.0F, 14.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 8.5F, 7.5F, 0.0F, 0.0F, -1.570796F));
        ...
        PartDefinition block1_24 = root.addOrReplaceChild("block1_24", CubeListBuilder.create().texOffs(15, 15).addBox(-2.0F, -7.0F, -0.5F, 2.0F, 14.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 8.5F, -7.5F, 0.0F, 0.0F, -1.570796F));
        ...
        PartDefinition block = root.addOrReplaceChild("block", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -0.5F, -8.0F, 16.0F, 1.0F, 16.0F), PartPose.offsetAndRotation(0.0F, 23.5F, 0.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition block_2 = root.addOrReplaceChild("block_2", CubeListBuilder.create().texOffs(7, 0).addBox(-8.0F, -0.5F, -8.0F, 16.0F, 1.0F, 16.0F), PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.0F));
    ...
    private static LayerDefinition model_litter_box() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        PartDefinition root_node = root.addOrReplaceChild("root_node", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 23.5F, 0.0F, 0.0F, 0.0F, 0.0F));
    ...
    private static LayerDefinition model_pet_bowl() {
        MeshDefinition mesh = new MeshDefinition();
        PartDefinition root = mesh.getRoot();
        PartDefinition root__node = root.addOrReplaceChild("root__node", CubeListBuilder.create(), PartPose.offsetAndRotation(-8.0F, 22.5F, 8.0F, 0.0F, 0.0F, 0.0F));
        ...
        PartDefinition side_4 = root__node.addOrReplaceChild("side_4", CubeListBuilder.create().texOffs(12, 12).addBox(3.35F, -5.0F, -2.0F, 1.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, -0.785398F, 0.0F));
        PartDefinition side_6 = root__node.addOrReplaceChild("side_6", CubeListBuilder.create().texOffs(12, 12).addBox(3.35F, -5.0F, -2.0F, 1.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, 0.785398F, 0.0F));
        PartDefinition side_5 = root__node.addOrReplaceChild("side_5", CubeListBuilder.create().texOffs(12, 12).addBox(-4.35F, -5.0F, -2.0F, 1.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, 0.785398F, 0.0F));
        ...
        PartDefinition side_3 = root__node.addOrReplaceChild("side_3", CubeListBuilder.create().texOffs(12, 12).addBox(-4.35F, -5.0F, -2.0F, 1.0F, 4.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.0F, 0.0F, 0.0F, -0.785398F, 0.0F));
        return LayerDefinition.create(mesh, 64, 32);
    }
    private static LayerDefinition model_ragdoll() {
        ...
        PartDefinition lower_body = body.addOrReplaceChild("lower_body", CubeListBuilder.create().texOffs(80, 41).addBox(-4.0F, -4.0F, -0.5F, 8.0F, 9.0F, 13.0F), PartPose.offsetAndRotation(0.0F, -1.0F, 4.0F, -0.044147F, 0.0F, 0.0F));
        PartDefinition tail = lower_body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(44, 16).addBox(-1.5F, -2.0F, 0.5F, 3.0F, 4.0F, 9.0F), PartPose.offsetAndRotation(0.0F, -3.0F, 5.0F, -0.973323F, 0.0F, 0.0F));
        PartDefinition tail2 = tail.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(71, 27).addBox(-1.5F, -2.0F, 0.5F, 3.0F, 4.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, 0.404708F, 0.0F, 0.0F));
        PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(62, 6).addBox(-2.0F, -2.5F, -1.0F, 4.0F, 5.0F, 6.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 3.0F, 0.436277F, 0.0F, 0.0F));
        PartDefinition tail4 = tail3.addOrReplaceChild("tail4", CubeListBuilder.create().texOffs(57, 5).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 4.0F, 2.0F), PartPose.offsetAndRotation(0.0F, -1.0F, 3.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition back_leg_r1 = lower_body.addOrReplaceChild("back_leg_r1", CubeListBuilder.create().texOffs(19, 51).addBox(-1.0F, 0.5F, -2.0F, 2.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(-4.0F, -4.5F, 3.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition back_leg_r2 = back_leg_r1.addOrReplaceChild("back_leg_r2", CubeListBuilder.create().texOffs(18, 35).addBox(-0.99F, -2.5F, -0.8F, 2.0F, 12.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 1.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition back_leg_l1 = lower_body.addOrReplaceChild("back_leg_l1", CubeListBuilder.create().texOffs(19, 51).addBox(-1.0F, 0.5F, -2.0F, 2.0F, 8.0F, 5.0F), PartPose.offsetAndRotation(4.0F, -4.5F, 3.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition back_leg_l2 = back_leg_l1.addOrReplaceChild("back_leg_l2", CubeListBuilder.create().texOffs(18, 35).addBox(-1.01F, -2.5F, -0.8F, 2.0F, 12.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 2.5F, 1.0F, 0.0F, 0.0F, 0.0F));
        PartDefinition neck1 = body.addOrReplaceChild("neck1", CubeListBuilder.create().texOffs(11, 16).addBox(-2.5F, -2.0F, -7.0F, 5.0F, 6.0F, 10.0F), PartPose.offsetAndRotation(0.0F, -3.0F, -5.0F, -0.868145F, 0.0F, 0.0F));
        PartDefinition head_base = neck1.addOrReplaceChild("head_base", CubeListBuilder.create().texOffs(102, 4).addBox(-3.0F, -4.0F, -5.5F, 6.0F, 6.0F, 5.0F), PartPose.offsetAndRotation(0.0F, -1.0F, -1.7F, 1.038364F, 0.0F, 0.0F));
        PartDefinition head_front = head_base.addOrReplaceChild("head_front", CubeListBuilder.create().texOffs(0, 12).addBox(-2.0F, -2.0F, -5.4F, 4.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, 1.0F, 1.5F, 0.15708F, 0.0F, 0.0F));
        PartDefinition head_slope = head_front.addOrReplaceChild("head_slope", CubeListBuilder.create().texOffs(37, 11).addBox(-1.0F, -2.0F, -5.4F, 2.0F, 2.0F, 5.0F), PartPose.offsetAndRotation(0.0F, -1.0F, 3.0F, 0.351233F, 0.0F, 0.0F));
        PartDefinition nose = head_slope.addOrReplaceChild("nose", CubeListBuilder.create().texOffs(10, 0).addBox(-0.5F, 0.1F, -1.3F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, -0.7F, -1.5F, -0.176772F, 0.0F, 0.0F));
        PartDefinition jaw = head_base.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(0, 20).addBox(-1.5F, -0.7F, -3.0F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(0.0F, 2.4F, -0.5F, -0.009828F, 0.0F, 0.0F));
        PartDefinition cheek_l = head_base.addOrReplaceChild("cheek_l", CubeListBuilder.create().texOffs(32, 41).addBox(0.5F, -3.1F, -2.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(1.4F, 1.0F, 2.0F, 0.031686F, 0.176182F, -0.084957F));
        PartDefinition cheek_l2 = cheek_l.addOrReplaceChild("cheek_l2", CubeListBuilder.create().texOffs(32, 36).addBox(0.5F, -2.1F, -2.0F, 3.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(-1.0F, 0.6F, 1.5F, 0.0F, 0.240054F, 0.0F));
        PartDefinition cheek_r = head_base.addOrReplaceChild("cheek_r", CubeListBuilder.create().texOffs(32, 41).addBox(-3.5F, -3.1F, -2.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(-1.4F, 1.0F, 2.0F, 0.031686F, -0.176182F, 0.084957F));
        PartDefinition cheek_r2 = cheek_r.addOrReplaceChild("cheek_r2", CubeListBuilder.create().texOffs(32, 36).addBox(-3.5F, -2.1F, -2.0F, 3.0F, 3.0F, 2.0F), PartPose.offsetAndRotation(1.0F, 0.6F, 1.5F, 0.0F, -0.240054F, 0.0F));
        PartDefinition ear_r = head_base.addOrReplaceChild("ear_r", CubeListBuilder.create().texOffs(3, 3).addBox(-2.0F, -1.1F, -2.5F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(-2.5F, -2.5F, 0.700001F, -1.513855F, 0.042108F, -0.532973F));
        PartDefinition ear_r2 = ear_r.addOrReplaceChild("ear_r2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.1F, -1.0F, 2.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.6F, -1.7F, 0.150501F, 0.0F, 0.0F));
        PartDefinition ear_r3 = ear_r2.addOrReplaceChild("ear_r3", CubeListBuilder.create().texOffs(1, 0).addBox(-0.5F, -1.1F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.6F, -0.3F, 0.189827F, 0.0F, 0.0F));
        PartDefinition ear_l = head_base.addOrReplaceChild("ear_l", CubeListBuilder.create().texOffs(3, 3).addBox(-1.0F, -1.1F, -2.5F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(2.5F, -2.5F, 0.700001F, -1.513855F, -0.042108F, 0.532972F));
        PartDefinition ear_l2 = ear_l.addOrReplaceChild("ear_l2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.1F, -1.0F, 2.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.6F, -1.7F, 0.150501F, 0.0F, 0.0F));
        PartDefinition ear_l3 = ear_l2.addOrReplaceChild("ear_l3", CubeListBuilder.create().texOffs(1, 0).addBox(-0.5F, -1.1F, -1.0F, 1.0F, 1.0F, 1.0F), PartPose.offsetAndRotation(0.0F, 0.6F, -0.3F, 0.189827F, 0.0F, 0.0F));
        PartDefinition mane = neck1.addOrReplaceChild("mane", CubeListBuilder.create().texOffs(96, 22).addBox(-5.0F, -2.2F, -5.0F, 10.0F, 8.0F, 6.0F), PartPose.offsetAndRotation(0.0F, -2.5F, 3.0F, 0.160293F, 0.0F, 0.0F));
        PartDefinition leg_r1 = body.addOrReplaceChild("leg_r1", CubeListBuilder.create().texOffs(2, 37).addBox(-1.0F, -0.5F, -2.0F, 2.0F, 9.0F, 4.0F), PartPose.offsetAndRotation(-4.2F, -5.0F, -2.0F, -0.034907F, 0.0F, 0.0F));
        PartDefinition leg_r2 = leg_r1.addOrReplaceChild("leg_r2", CubeListBuilder.create().texOffs(1, 52).addBox(-0.88F, -0.5F, -2.1F, 2.0F, 9.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.0F, 0.2F, 0.0F, 0.0F, 0.0F));
        PartDefinition leg_l1 = body.addOrReplaceChild("leg_l1", CubeListBuilder.create().texOffs(2, 37).addBox(-1.0F, -0.5F, -2.0F, 2.0F, 9.0F, 4.0F), PartPose.offsetAndRotation(4.2F, -5.0F, -2.0F, -0.034907F, 0.0F, 0.0F));
        PartDefinition leg_l2 = leg_l1.addOrReplaceChild("leg_l2", CubeListBuilder.create().texOffs(1, 52).addBox(-1.12F, -0.5F, -2.1F, 2.0F, 9.0F, 3.0F), PartPose.offsetAndRotation(0.0F, 4.0F, 0.2F, 0.0F, 0.0F, 0.0F));
