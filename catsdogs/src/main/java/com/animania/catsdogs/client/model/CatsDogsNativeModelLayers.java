...
public final class CatsDogsNativeModelLayers {
    ...
    private static LayerDefinition model_cat_bed_2() {
        ...
        PartDefinition side_2 = side.addOrReplaceChild("side_2", CubeListBuilder.create().texOffs(5, 0).addBox(-3.5F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(7.0F, 0.0F, 7.0F, 0.0F, -1.570797F, 0.0F));
        ...
        PartDefinition side_4 = side.addOrReplaceChild("side_4", CubeListBuilder.create().texOffs(5, 0).addBox(-3.5F, -1.0F, 6.0F, 7.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 7.0F, 0.0F, -2.356194F, 0.0F));
        ...
        PartDefinition side_6 = side.addOrReplaceChild("side_6", CubeListBuilder.create().texOffs(5, 0).addBox(-3.5F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(-7.0F, 0.0F, 6.999999F, 0.0F, -1.570797F, 0.0F));
        PartDefinition side_7 = side.addOrReplaceChild("side_7", CubeListBuilder.create().texOffs(5, 0).addBox(-3.5F, -1.0F, -1.0F, 7.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(-0.000002F, 0.0F, 14.0F, -6.283185F, 3.141593F, 0.0F));
        PartDefinition side_8 = side.addOrReplaceChild("side_8", CubeListBuilder.create().texOffs(5, 0).addBox(-3.5F, -1.0F, -8.0F, 7.0F, 2.0F, 2.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 7.0F, 0.0F, -2.356194F, 0.0F));
        ...
        PartDefinition bottom_4 = bottom_3.addOrReplaceChild("bottom_4", CubeListBuilder.create().texOffs(0, 14).addBox(-3.5F, -1.0F, -8.0F, 7.0F, 2.0F, 16.0F), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -1.570797F, 0.0F));
        return LayerDefinition.create(mesh, 64, 32);
    }
    ...
    private static LayerDefinition model_litter_box() {
        ...
        PartDefinition pooper__scooper__back = root_node.addOrReplaceChild("pooper__scooper__back", CubeListBuilder.create().texOffs(13, 53).addBox(-3.5F, -2.5F, -0.5F, 7.0F, 5.0F, 1.0F), PartPose.offsetAndRotation(4.0F, 4.0F, -4.9F, 0.097096F, -0.901621F, -0.02839F));
        ...
        PartDefinition pooper__scooper__handle = pooper__scooper__back.addOrReplaceChild("pooper__scooper__handle", CubeListBuilder.create().texOffs(6, 46).addBox(-1.0F, -1.0F, -4.0F, 2.0F, 2.0F, 8.0F), PartPose.offsetAndRotation(0.0F, 1.000001F, -2.25F, 0.135637F, 0.000708F, 0.00014F));
    ...
    private static LayerDefinition model_ragdoll() {
        ...
        PartDefinition cheek_l = head_base.addOrReplaceChild("cheek_l", CubeListBuilder.create().texOffs(32, 41).addBox(0.5F, -1.9F, -0.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(1.4F, -1.0F, -2.0F, 0.046449F, -0.17291F, 0.08373F));
        ...
        PartDefinition cheek_r = head_base.addOrReplaceChild("cheek_r", CubeListBuilder.create().texOffs(32, 41).addBox(-3.5F, -1.9F, -0.5F, 3.0F, 5.0F, 3.0F), PartPose.offsetAndRotation(-1.4F, -1.0F, -2.0F, 0.046449F, 0.17291F, -0.08373F));
        ...
        PartDefinition ear_r = head_base.addOrReplaceChild("ear_r", CubeListBuilder.create().texOffs(3, 3).addBox(-2.0F, 0.1F, -1.5F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(-2.5F, 2.5F, -0.700001F, -1.032703F, -1.459621F, 1.433052F));
        ...
        PartDefinition ear_l = head_base.addOrReplaceChild("ear_l", CubeListBuilder.create().texOffs(3, 3).addBox(-1.0F, 0.1F, -1.5F, 3.0F, 1.0F, 4.0F), PartPose.offsetAndRotation(2.5F, 2.5F, -0.700001F, -1.032703F, 1.459622F, -1.433053F));
