...
public final class FarmConfig {
    ...
    static {
        ...
        CHICKEN_FOOD = builder.defineList("chickenFood", List.of("minecraft:wheat_seeds", "minecraft:melon_seeds", "minecraft:beetroot_seeds", "minecraft:pumpkin_seeds"), value -> value instanceof String);
        COW_FOOD = builder.defineList("cowFood", List.of("minecraft:wheat"), value -> value instanceof String);
        GOAT_FOOD = builder.defineList("goatFood", List.of("minecraft:wheat", "minecraft:string", "minecraft:stick", "minecraft:apple"), value -> value instanceof String);
        HORSE_FOOD = builder.defineList("horseFood", List.of("minecraft:wheat", "minecraft:apple", "minecraft:carrot"), value -> value instanceof String);
        SHEEP_FOOD = builder.defineList("sheepFood", List.of("minecraft:wheat"), value -> value instanceof String);
        ...
        beds.put("chickenBed", builder.define("chickenBed", "animania_farm:animania_wool"));
        beds.put("chickenBed2", builder.define("chickenBed2", "minecraft:grass_block"));
        beds.put("cowBed", builder.define("cowBed", "animania_farm:animania_wool"));
        beds.put("cowBed2", builder.define("cowBed2", "minecraft:grass_block"));
        beds.put("goatBed", builder.define("goatBed", "animania_farm:animania_wool"));
        beds.put("goatBed2", builder.define("goatBed2", "minecraft:grass_block"));
        beds.put("horseBed", builder.define("horseBed", "animania_farm:animania_wool"));
        beds.put("horseBed2", builder.define("horseBed2", "minecraft:grass_block"));
        beds.put("pigBed", builder.define("pigBed", "animania_farm:animania_wool"));
        beds.put("pigBed2", builder.define("pigBed2", "minecraft:grass_block"));
        beds.put("sheepBed", builder.define("sheepBed", "animania_farm:animania_wool"));
